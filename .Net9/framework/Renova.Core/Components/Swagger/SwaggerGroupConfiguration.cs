...
public class SwaggerGroupConfiguration : IConfigureOptions<SwaggerGenOptions>
{
    private readonly IApiDescriptionGroupCollectionProvider _provider;

    public SwaggerGroupConfiguration(IApiDescriptionGroupCollectionProvider provider)
    {
        _provider = provider;
    }
