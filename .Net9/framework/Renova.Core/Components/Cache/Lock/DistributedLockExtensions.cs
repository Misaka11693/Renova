...
public static class DistributedLockExtensions
{
    ...
    public static async Task<LockController?> LockAsync(this ICache cache, string name, int timeoutSeconds = 30, bool autoDelay = true)
    {
    ...
    public static LockController? TryLockAsync(this ICache cache, string name, int timeoutSeconds = 30, bool autoDelay = true)
    {
        if (string.IsNullOrEmpty(name)) throw new ArgumentNullException(nameof(name));
